...
* **Performance on Tabular Data:** In many research contexts, particularly with structured or tabular datasets, MLPs outperform complex models like Transformers due to their simplicity and ability to learn direct features.
...
* **Data Requirements:** They require large amounts of labeled data to train effectively.