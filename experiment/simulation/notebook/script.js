...
function unlockNextStep() {
    ...
    // Unlock the content block visually (just enables the Run button)
...
function injectSidebarActions() {
    ...
    footer.innerHTML = `
        <a href="../MLPpdf.pdf" download="MLPpdf.pdf" id="btnDownloadPdf" class="action-btn btn-download-pdf" style="text-decoration: none;">
